        ...
        <div class="row align-items-center min-vh-mobile">
          ...
          <div class="col-lg-6 col-md-4 d-none d-md-block">
            <div class="hero-image text-center">
              <img src="/images/hero-outdoor.jpg" alt="Sustainable Outdoor Adventure" class="img-fluid rounded-3 shadow-lg">
            </div>
          </div>
        </div>
      </div>
    ...
    return {
      ...
      featuredProducts: [
        ...
        },
        {
          ...
          price: 892.95,
          image: '/images/solar-backpack.jpg'
        },
        {
          id: 3,
      ...
      testimonials: [
        ...
        },
        {
          ...
          avatar: '/images/emma-rodriguez.jpg'
        }
      ]
    }
  },
